...
<div class="container-fluid">
  ...
  <div style="justify-content: space-between; align-items: center; margin-bottom:10px;" class="d-none d-flex">
    <h3 class="mb-0 text-gray-800 col-md-6">Data Akun</h3>
              ...
              <tbody>
                ...
                <?php foreach ($accounts as $account) : ?>
                  <tr class="text-center align-middle">
                    ...
                    <td>
                      <?php if ($account['is_active'] == "active") : ?>
                        Aktif
                      <?php endif; ?>

                      <?php if ($account['is_active'] == 'not_active') : ?>
                        Non-Aktif
                      <?php endif; ?>
                    </td>
                    <td>
                      <button type="button" class="btn btn-warning" id="btnEdit" data-bs-toggle="modal" data-bs-target="#editAccount" data-id="<?= $account['user_id']; ?>" data-nama="<?= $account['nama_lengkap']; ?>" data-email="<?= $account['email']; ?>" data-username="<?= $account['username']; ?>" data-password="<?= $account['password']; ?>" data-status="<?= $account['is_active']; ?>">
  ...
  <div class="modal-dialog modal-dialog-centered modal-md">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          <label for="statusAkunUser">Status Akun</label>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              <label for="editNamaUser">Nama Lengkap</label>
          ...
          <div class="col-md-6">
            <div class="form-group">
              <label for="editEmailUser">Email</label>
        ...
        <div class="form-group">
          <label for="editStatusAkunUser">Status Akun</label>
...
<script>
  $(document).on('click', '#btnEdit', function() {
    ...
    $('.modal-body #editPassUser').val($(this).data('password'));
