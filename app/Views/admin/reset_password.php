                        ...
                        <div class="row" style="align-items: center;">
                            <div class="col">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="POST">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="token" class="form-control form-control-user"
                                                id="inputToken" aria-describedby="tokenHelp"
                                        ...
                                        <div class="form-group">
                                            <input type="password" name="confirmPassword" class="form-control form-control-user"
                                                id="inputConfirmPassword" placeholder="Confirm New Password..." required>
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="/admin">Already Reset Password ? Login Here !!!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
